...
* Take a screenshot of the recipient’s address balance and history from your Ganache application. Save this screenshot to the README.md file of your GitHub repository for this Challenge assignment.
 ...
 ![PyChain Transaction Record](./Images/StreamlitPreTransaction.png)


 ![Validation Transaction](./Images/StreamlitPostTransaction.png)


![Terminal Run Streamlit](./Images/GanachePreTranaction.png)


![Streamlit imputing Records](./Images/GanacheAfterTranaction.png)
---
